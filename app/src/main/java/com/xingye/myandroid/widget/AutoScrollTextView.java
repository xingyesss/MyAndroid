...
/**
 * 通知栏垂直滚动的TextView
 * Created by sunxiquan on 2017/5/10.
 */
...
public class AutoScrollTextView extends TextSwitcher implements ViewSwitcher.ViewFactory {
    ...
    public AutoScrollTextView(Context context, AttributeSet attrs) {
        ...
        mTextSize = a.getFloat(R.styleable.autoScrollHeight_textSize, 24);
        mPadding = (int) a.getFloat(R.styleable.autoScrollHeight_padding, 20);
